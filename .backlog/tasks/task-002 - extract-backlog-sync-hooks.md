...
references: ["openspec/changes/extract-backlog-sync-hooks/proposal.md", "openspec/changes/extract-backlog-sync-hooks/design.md", "openspec/changes/extract-backlog-sync-hooks/tasks.md", "openspec/changes/extract-backlog-sync-hooks/plan.md"]
documentation: ["openspec/changes/extract-backlog-sync-hooks/.openspec.yaml"]
