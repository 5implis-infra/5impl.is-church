...
> **Este documento foi movido para `docs/old/`. O conteúdo aqui está desatualizado e não deve ser usado como referência autoritativa. Para informação atual, consulte `docs/ARCHITECTURE.md`, `docs/PRODUCT.md` e `docs/adrs/*.md`.**
